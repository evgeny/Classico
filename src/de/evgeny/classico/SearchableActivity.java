...
public class SearchableActivity extends ActionBarActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.serach_resuls);
...
//	}
	...
	private void showResults(String query) {
		...
		if (cursor == null) {
			...
			// columns to go
			int[] to = new int[] { R.id.composer, R.id.composition };

			// Create a simple cursor adapter for the definitions and apply them
			// to the ListView
			SimpleCursorAdapter titleAdapter = new SimpleCursorAdapter(this, R.layout.result,
					cursor, from, to);
